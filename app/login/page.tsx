...
const Login = () => {
    ...
    return (
        <React.Fragment>
            <form onSubmit={handleSubmit(onLogin)} className='mx-auto my-20 w-3/4 shadow-inner rounded-lg p-4 md:p-8 bg-slate-300'>
                ...
                <Button text='Login' type='submit' variant='secondary' handleClick={() => handleSubmit(onLogin)} />
            </form>
        </React.Fragment>
    )
}
